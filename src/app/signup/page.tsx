    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-secondary mt-1">Start your journey with Sprout</p>
        </div>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center"><span className="bg-page px-3 text-xs text-secondary">or sign up with email</span></div>
        </div>
        ...
        <p className="text-center text-sm text-secondary mt-6">
          ...
          <Link href="/login" className="text-accent hover:text-accent-hover font-medium transition-colors duration-200">Sign in</Link>
        </p>
      </div>
    </div>
  )
